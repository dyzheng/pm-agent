...
1. **FE-205** (100.0/100): constrained DFT 框架（f 电子数约束）
   - Feasibility: high, Novelty: frontier, Value: critical
   - Action: `promote_to_priority`

2. **FE-200** (95.0/100): 自适应 Kerker 预处理参数
   - Feasibility: high, Novelty: advanced, Value: critical
   - Action: `promote_to_priority`

3. **FE-204** (91.0/100): 能量监控 + SCF 自动回退机制
   - Feasibility: medium, Novelty: frontier, Value: critical
   - Action: `proceed`
...
- **Priority:** 95.0/100
- **Feasibility:** high — 2 dependencies
- **Novelty:** advanced — Advanced automation or adaptive methods
- **Value:** critical — On critical path
- **Action:** `promote_to_priority`
